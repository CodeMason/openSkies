...
public class CharacterAppearanceSettings extends Table implements Disposable {
    ...
    public CharacterAppearanceSettings(final Skin skin, final CharacterAppearanceTable parent) {
        ...
        facialHairNode = buildFacialHairNode(null, null);
        actionsTree.add(facialHairNode);
    ...
    public void update(final CharacterAppearanceData buildData, final CharacterClothingData clothing) {
        ...
        final Collection<BaseDetails> facialHairStyles = parent.getAvailableFacialHairStyles();
        final boolean differentFacialHairStyles = differentCollections(availableFacialHairStyles, facialHairStyles);
        
        if (differentFacialHairStyles) {
            availableFacialHairStyles = facialHairStyles;
        }
        
        final Collection<BaseDetails> facialHairColors = parent.getAvailableFacialHairColors();
        final boolean differentFacialHairColors = differentCollections(availableFacialHairColors, facialHairColors);
        
        if (differentFacialHairColors) {
            availableFacialHairColors = facialHairColors;
        }
        
        if (differentFacialHairStyles || differentFacialHairColors) {
            buildFacialHairNode(buildData.getFacialHairStyle(), buildData.getFacialHairColor());
        }
        ...
        if (differentShirtColors) {
            ...
            buildShirtColorNode(clothing.getShirtColor());
        }
        ...
        if (differentPantsColors) {
            ...
            buildPantsColorNode(clothing.getPantsColor());
        }

        if (availableShoeColors == null) {
            availableShoeColors = parent.getAvailableShoeColors();
            buildShoeColorNode(clothing.getShoeColor());
        }
    }
    ...
    private Tree.Node buildHairNode(final BaseDetails activeHairStyle, final BaseDetails activeHairColor) {
        ...
        stylesSelection.addListener(new ChangeListener() {
            ...
            public void changed(ChangeListener.ChangeEvent event, Actor actor) {
                ...
                final String selectedColors = colorsSelection.getSelected();
                final BaseDetails color = parent.getHairColorByDisplayName(selectedColors);
    ...
    private Tree.Node buildFacialHairNode(final BaseDetails activeFacialHairStyle, final BaseDetails activeFacialHairColor) {
        if (facialHairNode == null) {
            facialHairNode = buildLabeledNode("Facial Hair", skin);
        } else {
            facialHairNode.removeAll();
        }

        if (availableHairStyles == null) {
            return facialHairNode;
        }
        ...
        stylesSelection.addListener(new ChangeListener() {
            ...
            public void changed(ChangeListener.ChangeEvent event, Actor actor) {
                final String selected = stylesSelection.getSelected();
                final BaseDetails style = parent.getFacialHairStyleByDisplayName(selected);
                parent.setCharacterFacialHairStyle(style);
                final String selectedColor = colorsSelection.getSelected();
                final BaseDetails color = parent.getFacialHairColorByDisplayName(selectedColor);
                parent.setCharacterFacialHairColor(color);
            }
        });
        
        if (activeFacialHairStyle != null) {
            stylesSelection.setSelected(activeFacialHairStyle.getDisplayName());
        } else {
            stylesSelection.setSelectedIndex(0);
        }
        ...
        final Label colorLabel = new Label("Color:", skin);
        if (availableFacialHairColors == null) {
            colorsSelection.getItems().add("N/A");
            colorsSelection.setDisabled(true);
        } else {
            colorsSelection.setDisabled(false);
            ...
            colorsSelection.addListener(new ChangeListener() {
                ...
                public void changed(ChangeListener.ChangeEvent event, Actor actor) {
                    final String selected = colorsSelection.getSelected();
                    final BaseDetails color = parent.getFacialHairColorByDisplayName(selected);
                    parent.setCharacterFacialHairColor(color);
                }
            });
            if (activeFacialHairColor != null) {
                colorsSelection.setSelected(activeFacialHairColor.getDisplayName());
            } else {
                colorsSelection.setSelectedIndex(0);
            }
        }
        ...
        final Tree.Node stylesTableNode = new Tree.Node(styleTable);
        stylesTableNode.setSelectable(false);
        facialHairNode.add(stylesTableNode);
    ...
    private Tree.Node facialHairNode;
    ...
    private Collection<BaseDetails> availableFacialHairStyles = null;
    private Collection<BaseDetails> availableFacialHairColors = null;
